...
def LineCountbyMonth(request):
    ...
    result = {month: 0 for month in range(1, 13)}  # Initialize the result dict for each month

    # Fetch incidents for the current year
...
def MultilineIncidentTop3Country(request):
    ...
    for row in rows:
        ...
        # If the country is not in the result dictionary, initialize it with all months set to 0
    ...
    # Sort the months for each country
